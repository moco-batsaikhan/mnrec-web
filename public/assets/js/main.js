...
========================================*/
  ...
  document.addEventListener("DOMContentLoaded", function () {
    var tooltipTriggers = document.querySelectorAll(
      ".rs-portfolio-tooltip .rs-portfolio-tooltip-item",
    );
    ...
    function myFunction(e) {
      ...
      var tooltip = tooltipTrigger.querySelector(
  ...
  $(document).ready(function () {
    ...
    $(".rs-swiper .swiper").each(function (index) {
      var $swiper = $(this);
      var hoverAutoplay =
        $swiper.data("hover-pause") === undefined ? true : $swiper.data("hover-pause");
      var loop = $(this).data("loop") === undefined ? true : $(this).data("loop");
      var centeredSlides =
        $(this).data("center-mode") === undefined ? false : $(this).data("center-mode");
      var autoplay = $(this).data("autoplay") === undefined ? true : $(this).data("autoplay");
      var dynamicBullets =
        $(this).data("dots-dynamic") === undefined ? true : $(this).data("dots-dynamic");
      var direction = $(this).data("direction") === "vertical" ? "vertical" : "horizontal";
      var fridgeMovement =
        $(this).data("play-slide") === undefined ? true : $(this).data("play-slide");
      var effect = $(this).data("effect") || "slide"; //'slide' | 'fade' | 'cube' | 'coverflow' | 'flip' | 'creative' | 'cards';
      var grabCursor =
        $(this).data("grab-cursor") === undefined ? false : $(this).data("grab-cursor");
    ...
    // Improve submenu toggle: open when clicking the parent label too
    // After meanmenu builds the structure, delegate click to anchors that have a submenu sibling
    $(document).on("click", ".mean-container .mean-nav ul li > a", function (e) {
      var $li = $(this).parent("li");
      var $submenu = $li.children("ul");
      if ($submenu.length) {
        // prevent navigation for parent labels
        e.preventDefault();
    ...
    // Also keep the plus icon behavior in sync with our class
    $(document).on("click", ".mean-expand", function () {
