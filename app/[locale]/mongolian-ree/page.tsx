...
export default async function NewsDetailPage(props: any) {
  ...
  return (
    <div>
      <PageBanner pageName={t.medee4.pageTitle ?? "News"} />
            ...
            <div className="col-xl-8 col-lg-8">
              <div className="rs-postbox-details-wrapper">
                ...
                <div className="rs-postbox-content">
                  <h3 className="rs-postbox-details-title">{t.medee4.newsTitle}</h3>
                </div>
                <div className="rs-postbox-details-content">
                  <p>{t.medee4.newsDescription}</p>
                  <h3 className="rs-postbox-details-feature-title mb-20">{t.medee4.newsTitle1}</h3>
                  <p>{t.medee4.newsDescription1}</p>
                  <div className="rs-postbox-details-thumb-wrapper mb-30">
                    <div className="row g-5">
                      <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div className="rs-postbox-details-thumb">
                          <img src="/assets/images/gallery/application.png" alt="image" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <h3 className="rs-postbox-details-feature-title mb-20">{t.medee4.newsTitle2}</h3>
                  <p>{t.medee4.newsDescription2}</p>
                </div>
              </div>
            </div>
                    ...
                    <div className="sidebar-blog-item-wrapper">
                      ...
                      <div className="sidebar-blog-item">
                        <div className="sidebar-blog-thumb">
                          <a href="blog-details.html">
                            <img
                              src="/assets/images/gallery/product-wind-turbine.png"
                              alt="image"
                            />
                          </a>
                        </div>
                        <div className="sidebar-blog-content">
                          <h6 className="sidebar-blog-title">
                            <Link href={`/${lang}/application-rare-elements`}>
                              {t.menu.ree_uses}
                            </Link>
                          </h6>
                        </div>
