...
export default async function ApplicationRareElements(props: any) {
  ...
  return (
    <div>
      <PageBanner pageName={t.medee2.pageTitle ?? "News"} />
            ...
            <div className="col-xl-8 col-lg-8">
              <div className="rs-postbox-details-wrapper">
                ...
                <div className="rs-postbox-content">
                  ...
                  <h3 className="rs-postbox-details-title">{t.medee2.newsTitle}</h3>
                </div>
                <div className="rs-postbox-details-content">
                  <p>{t.medee2.newsDescription}</p>
                  ...
                  <div className="rs-postbox-details-thumb-wrapper mb-30">
                    <div className="row g-5">
                      <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div className="rs-postbox-details-thumb">
                          <img
                            src="/assets/images/gallery/product-electric-vehicle.png"
                            alt="image"
                          />
                        </div>
                      </div>
                      <div className="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                        <div className="rs-postbox-details-thumb">
                          <img src="/assets/images/gallery/product-headphone.png" alt="image" />
                        </div>
                      </div>
                    </div>
                  </div>
