...
export default async function AboutTeamDetail(props: any) {
          ...
          <div className="row g-5">
            ...
            <div className="col-xl-6 col-lg-6">
              <div className="rs-team-details-content">
                ...
                <h2 className="rs-team-details-title">{t.about.manager1}</h2>
                <span className="rs-team-details-desig">{t.about.jobPosition1}</span>
