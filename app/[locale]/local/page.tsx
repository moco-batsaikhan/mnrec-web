...
export default async function Local(props: any) {
  ...
  const sliderImages = [
    "/assets/images/gallery/sustainable/local/cover1.jpg",
    "/assets/images/gallery/sustainable/local/cover2.jpg",
    "/assets/images/gallery/sustainable/local/cover3.jpg",
    "/assets/images/gallery/sustainable/local/cover4.jpg",
  ];
            ...
            <div className="col-xl-8 col-lg-8">
              <div className="rs-postbox-details-wrapper">
                <div className="rs-postbox-content">
                  <h3 className="rs-postbox-details-title">{t.sustainable?.local?.pageTitle}</h3>
                </div>
