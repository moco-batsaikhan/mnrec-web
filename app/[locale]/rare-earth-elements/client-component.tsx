          ...
          <div className="grid-container">
            <div className="grid-item">
              <div className="grid-image">
                <img src="/assets/applications/1.jpg" alt="Dysprosium" />
              </div>
            ...
            <div className="grid-item">
              <div className="grid-image">
                <img src="/assets/applications/2.jpg" alt="Terbium" />
              </div>
              <div className="grid-text">
            ...
            <div className="grid-item">
              <div className="grid-image">
                <img src="/assets/applications/3.jpg" alt="Neodymium" />
              </div>
              <div className="grid-text">
            ...
            <div className="grid-item">
              <div className="grid-image">
                <img src="/assets/applications/4.webp" alt="Praseodymium" />
              </div>
              <div className="grid-text">
